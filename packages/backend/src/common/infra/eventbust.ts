...
class DomainNganuEvent {


  static register(anEventName: string, subscritor:AfterAnEvent ){

  }

  static dispatch(event: AnEvent){
...
DomainNganuEvent.register(AfterAnEvent.name, AfterAnEvent)
