...
import { Delete__usecase__PascalCase__DTOEnd } from "./delete-__usecase__(kebabCase).dto";



export class Delete__usecase__PascalCase__Controller extends BaseController<Delete__usecase__PascalCase__DTOEnd> {
